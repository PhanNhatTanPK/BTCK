...
<table class="table">
    ...
    // phần này là phần show data của plan
      ...
      echo "<td>";  if ($row["level"] == 1)  echo "</td>";
      ...
      echo "<td>"; ?> <a href="detailplan.php?id=<?php echo $row["id_plan"]; ?>"><button type="button" class="btn btn-primary">More</button></a> <?php echo "</td>";
      echo "</tr>";
      }
  ?>
